      ...
      <div className='max-w-2xl mx-auto px-8 py-16 flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-3'>
          <div className='flex items-center gap-3'>
            <div className={`w-3 h-3 rounded-full ${allOk ? 'bg-green-400' : 'bg-red-400'} animate-pulse`} />
        ...
        <div className='flex flex-col gap-3'>
          {services.map(service => (
            <Card key={service.name} className='bg-zinc-900 border-white/10 text-white'>
              <CardHeader className='pb-2'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center gap-2'>
                    <span className='text-white/40 text-xs'>{service.detail}</span>
                    <Badge
                      variant='outline'
